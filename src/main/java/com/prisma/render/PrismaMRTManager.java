...
public final class PrismaMRTManager implements AutoCloseable {
    ...
    public void applyDebugPass(
        ...
        if (debugMode == 0 || !(colorGpuTex instanceof MetalGpuTexture colorTex)) {
            return;
        }
        ...
        MTLBuiltinPipelines.encodeDebugPass(
